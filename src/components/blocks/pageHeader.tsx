...
export const PageHeaderBlock = Config.type("🏁 Page Header", { fields: {
  ...BasicBlock,
    ...
    <Block
      ...
      <nav className="py-8 px-16 bg-blue-100 flex flex-wrap items-center text-base">
        <a href="/" aria-label="Startseite" className="focus:outline ds-link-01-bold">
          <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" role="graphics-symbol img" focusable="false" aria-hidden="true" className="!h-[1.6rem] !w-[1.6rem]">
