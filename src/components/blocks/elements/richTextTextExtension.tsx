...
export const TextExtensionSchema = alinea.type('🔤 Text', {
...
export type TextExtensionSchema = alinea.infer<typeof TextExtensionSchema>;
  
export function Text({look, text, tag} : TextExtensionSchema) {
